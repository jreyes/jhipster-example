...
import jhipster.web.filter.CachingHttpHeadersFilter;
import jhipster.web.filter.StaticResourcesProductionFilter;
import jhipster.web.filter.gzip.GZipServletFilter;
